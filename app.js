...
async function recreateDB() {
    ...
    let instance1 = new
    Holograph({holograph_name: "ghost", creator: 'ABC', edition_number: 1});
    let instance2 = new
    Holograph({holograph_name: "ghost", creator: 'ABC', edition_number: 2});
    let instance3 = new
    Holograph({holograph_name: "ghost", creator: 'ABC', edition_number: 3});
